...
// Wanted to cleanup, but couldn't find params
	...
	static void GetCurrentDate(u32 *pUnknown1, u32 *pUnknown2) { NativeInvoke::Invoke<ScriptVoid>("GET_CURRENT_DATE", pUnknown1, pUnknown2); }
	static void GetPedGroupIndex(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("GET_PED_GROUP_INDEX", p0, p1); }
...
// Interesting ones to cleanup:
	...
	static void GetPedBonePosition(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5) { NativeInvoke::Invoke<ScriptVoid>("GET_PED_BONE_POSITION", p0, p1, p2, p3, p4, p5); }
	...
	static void GetRandomCharInAreaOffsetNoSave(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5, ScriptAny p6) { NativeInvoke::Invoke<ScriptVoid>("GET_RANDOM_CHAR_IN_AREA_OFFSET_NO_SAVE", p0, p1, p2, p3, p4, p5, p6); }
	...
	static ScriptAny GetStringWidth(ScriptAny p0) { return NativeInvoke::Invoke<ScriptAny>("GET_STRING_WIDTH", p0); }
	static ScriptAny GetStringWidthWithNumber(ScriptAny p0, ScriptAny p1) { return NativeInvoke::Invoke<ScriptAny>("GET_STRING_WIDTH_WITH_NUMBER", p0, p1); }
	static ScriptAny GetStringWidthWithString(ScriptAny p0, ScriptAny p1) { return NativeInvoke::Invoke<ScriptAny>("GET_STRING_WIDTH_WITH_STRING", p0, p1); }
	static void GetTimeOfDay(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("GET_TIME_OF_DAY", p0, p1); }
	...
	static void GetVehicleDirtLevel(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("GET_VEHICLE_DIRT_LEVEL", p0, p1); }
	...
	static void GivePedHelmet(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("GIVE_PED_HELMET", p0); }
	...
	static void GiveWeaponToChar(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3) { NativeInvoke::Invoke<ScriptVoid>("GIVE_WEAPON_TO_CHAR", p0, p1, p2, p3); }
	...
	static ScriptAny IsFontLoaded(ScriptAny p0) { return NativeInvoke::Invoke<ScriptAny>("IS_FONT_LOADED", p0); }
	...
	static ScriptAny IsObjectAttached(ScriptAny p0) { return NativeInvoke::Invoke<ScriptAny>("IS_OBJECT_ATTACHED", p0); }
	...
	static ScriptAny IsPointObscuredByAMissionEntity(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5) { return NativeInvoke::Invoke<ScriptAny>("IS_POINT_OBSCURED_BY_A_MISSION_ENTITY", p0, p1, p2, p3, p4, p5); }
	...
	static void LoadScene(ScriptAny p0, ScriptAny p1, ScriptAny p2) { NativeInvoke::Invoke<ScriptVoid>("LOAD_SCENE", p0, p1, p2); }
	...
	static void PlaySoundFrontend(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("PLAY_SOUND_FRONTEND", p0, p1); }
	...
	static void RetuneRadioToStationIndex(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("RETUNE_RADIO_TO_STATION_INDEX", p0); }
	...
	static void ReviveInjuredPed(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("REVIVE_INJURED_PED", p0); }
	...
	static void SetBlipAsFriendly(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_BLIP_AS_FRIENDLY", p0, p1); }
	static void SetBlipAsShortRange(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_BLIP_AS_SHORT_RANGE", p0, p1); }
	...
	static void SetCarCanBeDamaged(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CAR_CAN_BE_DAMAGED", p0, p1); }
	static void SetCarCanBeVisiblyDamaged(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CAR_CAN_BE_VISIBLY_DAMAGED", p0, p1); }
	...
	static void SetCarCoordinates(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3) { NativeInvoke::Invoke<ScriptVoid>("SET_CAR_COORDINATES", p0, p1, p2, p3); }
	...
	static void SetCarForwardSpeed(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CAR_FORWARD_SPEED", p0, p1); }
	...
	static void SetCarHeading(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CAR_HEADING", p0, p1); }
	static void SetCarHealth(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CAR_HEALTH", p0, p1); }
	...
	static ScriptAny SetCarOnGroundProperly(ScriptAny p0) { return NativeInvoke::Invoke<ScriptAny>("SET_CAR_ON_GROUND_PROPERLY", p0); }
	...
	static void SetCarStrong(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CAR_STRONG", p0, p1); }
	static void SetCarVisible(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CAR_VISIBLE", p0, p1); }
	static void SetCharAccuracy(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_ACCURACY", p0, p1); }
	static void SetCharAllowedToDuck(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_ALLOWED_TO_DUCK", p0, p1); }
	static void SetCharAmmo(ScriptAny p0, ScriptAny p1, ScriptAny p2) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_AMMO", p0, p1, p2); }
	...
	static void SetCharAsEnemy(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_AS_ENEMY", p0, p1); }
	static void SetCharAsMissionChar(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_AS_MISSION_CHAR", p0); }
	static void SetCharCanBeKnockedOffBike(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_CAN_BE_KNOCKED_OFF_BIKE", p0, p1); }
	static void SetCharCanBeShotInVehicle(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_CAN_BE_SHOT_IN_VEHICLE", p0, p1); }
	static void SetCharCanSmashGlass(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_CAN_SMASH_GLASS", p0, p1); }
	static void SetCharCantBeDraggedOut(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_CANT_BE_DRAGGED_OUT", p0, p1); }
	...
	static void SetCharComponentVariation(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_COMPONENT_VARIATION", p0, p1, p2, p3); }
	static void SetCharCoordinates(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_COORDINATES", p0, p1, p2, p3); }
	...
	static void SetCharDefaultComponentVariation(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_DEFAULT_COMPONENT_VARIATION", p0); }
	static void SetCharDesiredHeading(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_DESIRED_HEADING", p0, p1); }
	...
	static void SetCharDropsWeaponsWhenDead(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_DROPS_WEAPONS_WHEN_DEAD", p0, p1); }
	...
	static void SetCharDruggedUp(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_DRUGGED_UP", p0, p1); }
	static ScriptAny SetCharDucking(ScriptAny p0, ScriptAny p1) { return NativeInvoke::Invoke<ScriptAny>("SET_CHAR_DUCKING", p0, p1); }
	static void SetCharFireDamageMultiplier(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_FIRE_DAMAGE_MULTIPLIER", p0, p1); }
	...
	static void SetCharGravity(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_GRAVITY", p0, p1); }
	static void SetCharHeading(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_HEADING", p0, p1); }
	static void SetCharInvincible(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_INVINCIBLE", p0, p1); }
	static void SetCharIsTargetPriority(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_IS_TARGET_PRIORITY", p0, p1); }
	static void SetCharKeepTask(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_KEEP_TASK", p0, p1); }
	static void SetCharMaxHealth(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_MAX_HEALTH", p0, p1); }
	...
	static void SetCharMoney(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_MONEY", p0, p1); }
	...
	static void SetCharNeverLeavesGroup(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_NEVER_LEAVES_GROUP", p0, p1); }
	...
	static void SetCharPropIndex(ScriptAny p0, ScriptAny p1, ScriptAny p2) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_PROP_INDEX", p0, p1, p2); }
	static void SetCharRandomComponentVariation(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_RANDOM_COMPONENT_VARIATION", p0); }
	...
	static void SetCharSphereDefensiveArea(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_SPHERE_DEFENSIVE_AREA", p0, p1, p2, p3, p4); }
	...
	static void SetCharSuffersCriticalHits(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_SUFFERS_CRITICAL_HITS", p0, p1); }
	...
	static void SetCharVelocity(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_VELOCITY", p0, p1, p2, p3); }
	static void SetCharVisible(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_VISIBLE", p0, p1); }
	static void SetCharWantedByPolice(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_WANTED_BY_POLICE", p0, p1); }
	...
	static void SetCharWillDoDrivebys(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_WILL_DO_DRIVEBYS", p0, p1); }
	static void SetCharWillFlyThroughWindscreen(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_WILL_FLY_THROUGH_WINDSCREEN", p0, p1); }
	...
	static void SetCharWillMoveWhenInjured(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_WILL_MOVE_WHEN_INJURED", p0, p1); }
	...
	static void SetCharWillUseCarsInCombat(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_WILL_USE_CARS_IN_COMBAT", p0, p1); }
	...
	static void SetCurrentCharWeapon(ScriptAny p0, ScriptAny p1, ScriptAny p2) { NativeInvoke::Invoke<ScriptVoid>("SET_CURRENT_CHAR_WEAPON", p0, p1, p2); }
	...
	static void SetDriveTaskCruiseSpeed(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_DRIVE_TASK_CRUISE_SPEED", p0, p1); }
	...
	static void SetEveryoneIgnorePlayer(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_EVERYONE_IGNORE_PLAYER", p0, p1); }
	static void SetExtraCarColours(ScriptAny p0, ScriptAny p1, ScriptAny p2) { NativeInvoke::Invoke<ScriptVoid>("SET_EXTRA_CAR_COLOURS", p0, p1, p2); }
	static void SetFakeWantedLevel(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_FAKE_WANTED_LEVEL", p0); }
	static void SetFloatStat(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_FLOAT_STAT", p0, p1); }
	static void SetGroupCharDucksWhenAimedAt(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_GROUP_CHAR_DUCKS_WHEN_AIMED_AT", p0, p1); }
	static void SetGroupFollowStatus(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_GROUP_FOLLOW_STATUS", p0, p1); }
	static void SetGroupFormation(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_GROUP_FORMATION", p0, p1); }
	static void SetGroupFormationSpacing(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_GROUP_FORMATION_SPACING", p0, p1); }
	static void SetGroupLeader(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_GROUP_LEADER", p0, p1); }
	static void SetGroupMember(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_GROUP_MEMBER", p0, p1); }
	static void SetGroupSeparationRange(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_GROUP_SEPARATION_RANGE", p0, p1); }
	...
	static void SetIgnoreLowPriorityShockingEvents(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_IGNORE_LOW_PRIORITY_SHOCKING_EVENTS", p0, p1); }
	...
	static void SetMissionFlag(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_MISSION_FLAG", p0); }
	...
	static void SetObjectCollision(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_OBJECT_COLLISION", p0, p1); }
	static void SetObjectCoordinates(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3) { NativeInvoke::Invoke<ScriptVoid>("SET_OBJECT_COORDINATES", p0, p1, p2, p3); }
	static void SetObjectDynamic(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_OBJECT_DYNAMIC", p0, p1); }
	static void SetObjectHeading(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_OBJECT_HEADING", p0, p1); }
	...
	static void SetObjectVisible(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_OBJECT_VISIBLE", p0, p1); }
	...
	static void SetPedDiesWhenInjured(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_PED_DIES_WHEN_INJURED", p0, p1); }
	...
	static void SetPedIsBlindRaging(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_PED_IS_BLIND_RAGING", p0, p1); }
	static void SetPedIsDrunk(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_PED_IS_DRUNK", p0, p1); }
	...
	static void SetPedPathMayDropFromHeight(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_PED_PATH_MAY_DROP_FROM_HEIGHT", p0, p1); }
	static void SetPedPathMayUseClimbovers(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_PED_PATH_MAY_USE_CLIMBOVERS", p0, p1); }
	static void SetPedPathMayUseLadders(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_PED_PATH_MAY_USE_LADDERS", p0, p1); }
	...
	static void SetPetrolTankHealth(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_PETROL_TANK_HEALTH", p0, p1); }
	...
	static void SetPoliceIgnorePlayer(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_POLICE_IGNORE_PLAYER", p0, p1); }
	static void SetPoliceRadarBlips(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_POLICE_RADAR_BLIPS", p0); }

	static void SetRadarZoom(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_RADAR_ZOOM", p0); }
	...
	static void SetTextBackground(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_TEXT_BACKGROUND", p0); }
	static void SetTextCentre(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_TEXT_CENTRE", p0); }
	static void SetTextColour(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3) { NativeInvoke::Invoke<ScriptVoid>("SET_TEXT_COLOUR", p0, p1, p2, p3); }
	static void SetTextDrawBeforeFade(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_TEXT_DRAW_BEFORE_FADE", p0); }
	static void SetTextDropshadow(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4) { NativeInvoke::Invoke<ScriptVoid>("SET_TEXT_DROPSHADOW", p0, p1, p2, p3, p4); }
	static void SetTextEdge(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4) { NativeInvoke::Invoke<ScriptVoid>("SET_TEXT_EDGE", p0, p1, p2, p3, p4); }
	static void SetTextFont(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_TEXT_FONT", p0); }
	static void SetTextJustify(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_TEXT_JUSTIFY", p0); }
	static void SetTextLineDisplay(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_TEXT_LINE_DISPLAY", p0, p1); }
	static void SetTextLineHeightMult(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_TEXT_LINE_HEIGHT_MULT", p0); }
	static void SetTextProportional(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_TEXT_PROPORTIONAL", p0); }
	static void SetTextRenderId(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_TEXT_RENDER_ID", p0); }
	static void SetTextRightJustify(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_TEXT_RIGHT_JUSTIFY", p0); }
	static void SetTextScale(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_TEXT_SCALE", p0, p1); }
	static void SetTextToUseTextFileColours(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_TEXT_TO_USE_TEXT_FILE_COLOURS", p0); }
	static void SetTextUseUnderscore(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_TEXT_USE_UNDERSCORE", p0); }
	static void SetTextWrap(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_TEXT_WRAP", p0, p1); }
	...
	static void SetTimeOfDay(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_TIME_OF_DAY", p0, p1); }
	...
	static void SetTimeScale(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_TIME_SCALE", p0); }
	...
	static void SetVehicleDirtLevel(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_VEHICLE_DIRT_LEVEL", p0, p1); }
	...
	static void SetWantedMultiplier(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_WANTED_MULTIPLIER", p0); }
	...
	static void SoundCarHorn(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SOUND_CAR_HORN", p0, p1); }
	static ScriptAny StartCharFire(ScriptAny p0) { return NativeInvoke::Invoke<ScriptAny>("START_CHAR_FIRE", p0); }
	...
	static ScriptAny StartScriptFire(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4) { return NativeInvoke::Invoke<ScriptAny>("START_SCRIPT_FIRE", p0, p1, p2, p3, p4); }
...
// For later....
	...
	static void AddCharDecisionMakerEventResponse(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5, ScriptAny p6, ScriptAny p7, ScriptAny p8) { NativeInvoke::Invoke<ScriptVoid>("ADD_CHAR_DECISION_MAKER_EVENT_RESPONSE", p0, p1, p2, p3, p4, p5, p6, p7, p8); }
	...
	static void AddObjectToInteriorRoomByKey(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("ADD_OBJECT_TO_INTERIOR_ROOM_BY_KEY", p0, p1); }
	...
	static void AllowGangRelationshipsToBeChangedByNextCommand(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("ALLOW_GANG_RELATIONSHIPS_TO_BE_CHANGED_BY_NEXT_COMMAND", p0); }
	...
	static void AllowScenarioPedsToBeReturnedByNextCommand(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("ALLOW_SCENARIO_PEDS_TO_BE_RETURNED_BY_NEXT_COMMAND", p0); }
	...
	static void ApplyForceToCar(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5, ScriptAny p6, ScriptAny p7, ScriptAny p8, ScriptAny p9, ScriptAny p10, ScriptAny p11) { NativeInvoke::Invoke<ScriptVoid>("APPLY_FORCE_TO_CAR", p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11); }
	static void ApplyForceToObject(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5, ScriptAny p6, ScriptAny p7, ScriptAny p8, ScriptAny p9, ScriptAny p10, ScriptAny p11) { NativeInvoke::Invoke<ScriptVoid>("APPLY_FORCE_TO_OBJECT", p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11); }
	static void ApplyForceToPed(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5, ScriptAny p6, ScriptAny p7, ScriptAny p8, ScriptAny p9, ScriptAny p10, ScriptAny p11) { NativeInvoke::Invoke<ScriptVoid>("APPLY_FORCE_TO_PED", p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11); }
	static ScriptAny AreAllNavmeshRegionsLoaded() { return NativeInvoke::Invoke<ScriptAny>("ARE_ALL_NAVMESH_REGIONS_LOADED"); }
	...
	static void AttachObjectToCar(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5, ScriptAny p6, ScriptAny p7, ScriptAny p8) { NativeInvoke::Invoke<ScriptVoid>("ATTACH_OBJECT_TO_CAR", p0, p1, p2, p3, p4, p5, p6, p7, p8); }
	...
	static void AttachObjectToPed(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5, ScriptAny p6, ScriptAny p7, ScriptAny p8, ScriptAny p9) { NativeInvoke::Invoke<ScriptVoid>("ATTACH_OBJECT_TO_PED", p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); }
	static void AttachPedToCar(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5, ScriptAny p6, ScriptAny p7, ScriptAny p8, ScriptAny p9) { NativeInvoke::Invoke<ScriptVoid>("ATTACH_PED_TO_CAR", p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); }
	...
	static void BlockCharGestureAnims(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("BLOCK_CHAR_GESTURE_ANIMS", p0, p1); }
	...
	static void BlockPedWeaponSwitching(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("BLOCK_PED_WEAPON_SWITCHING", p0, p1); }
	static void BlockPeekingInCover(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("BLOCK_PEEKING_IN_COVER", p0, p1); }
	static ScriptAny CamIsSphereVisible(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4) { return NativeInvoke::Invoke<ScriptAny>("CAM_IS_SPHERE_VISIBLE", p0, p1, p2, p3, p4); }
	...
	static void CancelCurrentlyPlayingAmbientSpeech(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("CANCEL_CURRENTLY_PLAYING_AMBIENT_SPEECH", p0); }
	...
	static void ClearCharDecisionMakerEventResponse(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("CLEAR_CHAR_DECISION_MAKER_EVENT_RESPONSE", p0, p1); }
	...
	static void ClearSequenceTask(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("CLEAR_SEQUENCE_TASK", p0); }
	...
	static void CloseSequenceTask(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("CLOSE_SEQUENCE_TASK", p0); }
	...
	static void ControlCarDoor(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3) { NativeInvoke::Invoke<ScriptVoid>("CONTROL_CAR_DOOR", p0, p1, p2, p3); }
	...
	static void CopyCharDecisionMaker(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("COPY_CHAR_DECISION_MAKER", p0, p1); }
	static void CopyCombatDecisionMaker(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("COPY_COMBAT_DECISION_MAKER", p0, p1); }
	static void CopyGroupCharDecisionMaker(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("COPY_GROUP_CHAR_DECISION_MAKER", p0, p1); }
	static void CopySharedCombatDecisionMaker(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("COPY_SHARED_COMBAT_DECISION_MAKER", p0, p1); }
	...
	static void CreateCam(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("CREATE_CAM", p0, p1); }
	...
	static void DestroyCam(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("DESTROY_CAM", p0); }
	...
	static ScriptAny DoesCamExist(ScriptAny p0) { return NativeInvoke::Invoke<ScriptAny>("DOES_CAM_EXIST", p0); }
	static ScriptAny DoesDecisionMakerExist(ScriptAny p0) { return NativeInvoke::Invoke<ScriptAny>("DOES_DECISION_MAKER_EXIST", p0); }
	...
	static void DrawRect(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5, ScriptAny p6, ScriptAny p7) { NativeInvoke::Invoke<ScriptVoid>("DRAW_RECT", p0, p1, p2, p3, p4, p5, p6, p7); }
	...
	static void FindStreetNameAtPosition(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4) { NativeInvoke::Invoke<ScriptVoid>("FIND_STREET_NAME_AT_POSITION", p0, p1, p2, p3, p4); }
	...
	static void ForcePedToFleeWhilstDrivingVehicle(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("FORCE_PED_TO_FLEE_WHILST_DRIVING_VEHICLE", p0, p1); }
	...
	static void GetCamFov(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("GET_CAM_FOV", p0, p1); }
	static void GetCamPos(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3) { NativeInvoke::Invoke<ScriptVoid>("GET_CAM_POS", p0, p1, p2, p3); }
	static void GetCamRot(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3) { NativeInvoke::Invoke<ScriptVoid>("GET_CAM_ROT", p0, p1, p2, p3); }
	...
	static ScriptAny GetClosestCarNode(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5) { return NativeInvoke::Invoke<ScriptAny>("GET_CLOSEST_CAR_NODE", p0, p1, p2, p3, p4, p5); }
	static ScriptAny GetClosestCarNodeWithHeading(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5, ScriptAny p6) { return NativeInvoke::Invoke<ScriptAny>("GET_CLOSEST_CAR_NODE_WITH_HEADING", p0, p1, p2, p3, p4, p5, p6); }
	static ScriptAny GetClosestMajorCarNode(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5) { return NativeInvoke::Invoke<ScriptAny>("GET_CLOSEST_MAJOR_CAR_NODE", p0, p1, p2, p3, p4, p5); }
	...
	static void GetFrameTime(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("GET_FRAME_TIME", p0); }
	...
	static void GetGameCam(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("GET_GAME_CAM", p0); }
	static void GetGameCamChild(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("GET_GAME_CAM_CHILD", p0); }
	...
	static void GetMobilePhoneRenderId(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("GET_MOBILE_PHONE_RENDER_ID", p0); }
	...
	static ScriptAny GetNthClosestCarNodeWithHeading(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5, ScriptAny p6, ScriptAny p7) { return NativeInvoke::Invoke<ScriptAny>("GET_NTH_CLOSEST_CAR_NODE_WITH_HEADING", p0, p1, p2, p3, p4, p5, p6, p7); }
	static ScriptAny GetNthClosestCarNodeWithHeadingOnIsland(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5, ScriptAny p6, ScriptAny p7, ScriptAny p8, ScriptAny p9) { return NativeInvoke::Invoke<ScriptAny>("GET_NTH_CLOSEST_CAR_NODE_WITH_HEADING_ON_ISLAND", p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); }
	static ScriptAny GetNumberOfPlayers() { return NativeInvoke::Invoke<ScriptAny>("GET_NUMBER_OF_PLAYERS"); }
	...
	static ScriptAny GetPlayerToPlaceBombInCar(ScriptAny p0) { return NativeInvoke::Invoke<ScriptAny>("GET_PLAYER_TO_PLACE_BOMB_IN_CAR", p0); }
	static void GetPlayersLastCarNoSave(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("GET_PLAYERS_LAST_CAR_NO_SAVE", p0); }
	static ScriptAny GetPlayerSettingsModelChoice() { return NativeInvoke::Invoke<ScriptAny>("GET_PLAYERSETTINGS_MODEL_CHOICE"); }
	...
	static void GetScriptRendertargetRenderId(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("GET_SCRIPT_RENDERTARGET_RENDER_ID", p0); }
	...
	static ScriptAny IsAmbientSpeechPlaying(ScriptAny p0) { return NativeInvoke::Invoke<ScriptAny>("IS_AMBIENT_SPEECH_PLAYING", p0); }
	...
	static ScriptAny IsCamActive(ScriptAny p0) { return NativeInvoke::Invoke<ScriptAny>("IS_CAM_ACTIVE", p0); }
	static ScriptAny IsCamInterpolating() { return NativeInvoke::Invoke<ScriptAny>("IS_CAM_INTERPOLATING"); }
	static ScriptAny IsCamPropagating(ScriptAny p0) { return NativeInvoke::Invoke<ScriptAny>("IS_CAM_PROPAGATING", p0); }
	static ScriptAny IsCharPlayingAnim(ScriptAny p0, ScriptAny p1, ScriptAny p2) { return NativeInvoke::Invoke<ScriptAny>("IS_CHAR_PLAYING_ANIM", p0, p1, p2); }
	...
	static ScriptAny IsPlayerOnline() { return NativeInvoke::Invoke<ScriptAny>("IS_PLAYER_ONLINE"); }
	...
	static ScriptAny IsScriptedSpeechPlaying(ScriptAny p0) { return NativeInvoke::Invoke<ScriptAny>("IS_SCRIPTED_SPEECH_PLAYING", p0); }
	...
	static ScriptAny LoadAllPathNodes(ScriptAny p0) { return NativeInvoke::Invoke<ScriptAny>("LOAD_ALL_PATH_NODES", p0); }
	static void LoadCharDecisionMaker(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("LOAD_CHAR_DECISION_MAKER", p0, p1); }
	static void LoadCombatDecisionMaker(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("LOAD_COMBAT_DECISION_MAKER", p0, p1); }
	...
	static ScriptAny NetworkIsGameRanked() { return NativeInvoke::Invoke<ScriptAny>("NETWORK_IS_GAME_RANKED"); }
	...
	static ScriptAny NetworkIsSessionStarted() { return NativeInvoke::Invoke<ScriptAny>("NETWORK_IS_SESSION_STARTED"); }
	...
	static void OpenSequenceTask(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("OPEN_SEQUENCE_TASK", p0); }
	...
	static void PlayAudioEvent(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("PLAY_AUDIO_EVENT", p0); }
	...
	static void PrintStringWithLiteralStringNow(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3) { NativeInvoke::Invoke<ScriptVoid>("PRINT_STRING_WITH_LITERAL_STRING_NOW", p0, p1, p2, p3); }
	...
	static void ReleaseSoundId(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("RELEASE_SOUND_ID", p0); }
	...
	static void RemoveDecisionMaker(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("REMOVE_DECISION_MAKER", p0); }
	...
	static void RequestCollisionAtPosn(ScriptAny p0, ScriptAny p1, ScriptAny p2) { NativeInvoke::Invoke<ScriptVoid>("REQUEST_COLLISION_AT_POSN", p0, p1, p2); }
...
//////////
	...
	static void SayAmbientSpeech(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4) { NativeInvoke::Invoke<ScriptVoid>("SAY_AMBIENT_SPEECH", p0, p1, p2, p3, p4); }
	...
	static void SetBlockingOfNonTemporaryEvents(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_BLOCKING_OF_NON_TEMPORARY_EVENTS", p0, p1); }
	static void SetBriansMood(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_BRIANS_MOOD", p0); }
	static void SetCamActive(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CAM_ACTIVE", p0, p1); }
	...
	static void SetCamFov(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CAM_FOV", p0, p1); }
	...
	static void SetCamPos(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3) { NativeInvoke::Invoke<ScriptVoid>("SET_CAM_POS", p0, p1, p2, p3); }
	static void SetCamPropagate(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CAM_PROPAGATE", p0, p1); }
	static void SetCamRot(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3) { NativeInvoke::Invoke<ScriptVoid>("SET_CAM_ROT", p0, p1, p2, p3); }
	...
	static void SetCamTargetPed(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CAM_TARGET_PED", p0, p1); }
	static void SetCameraControlsDisabledWithPlayerControls(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_CAMERA_CONTROLS_DISABLED_WITH_PLAYER_CONTROLS", p0); }
	...
	static void SetCarProofs(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5) { NativeInvoke::Invoke<ScriptVoid>("SET_CAR_PROOFS", p0, p1, p2, p3, p4, p5); }
	static void SetCharDecisionMaker(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_DECISION_MAKER", p0, p1); }
	static void SetCharDecisionMakerToDefault(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_DECISION_MAKER_TO_DEFAULT", p0); }
	...
	static void SetCharNotDamagedByRelationshipGroup(ScriptAny p0, ScriptAny p1, ScriptAny p2) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_NOT_DAMAGED_BY_RELATIONSHIP_GROUP", p0, p1, p2); }
	...
	static void SetCharProofs(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_PROOFS", p0, p1, p2, p3, p4, p5); }
	static void SetCharRelationship(ScriptAny p0, ScriptAny p1, ScriptAny p2) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_RELATIONSHIP", p0, p1, p2); }
	static void SetCharRelationshipGroup(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_CHAR_RELATIONSHIP_GROUP", p0, p1); }
	static void SetCinematicButtonEnabled(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_CINEMATIC_BUTTON_ENABLED", p0); }
	static void SetCombatDecisionMaker(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_COMBAT_DECISION_MAKER", p0, p1); }
	...
	static void SetDecisionMakerAttributeCanChangeTarget(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_DECISION_MAKER_ATTRIBUTE_CAN_CHANGE_TARGET", p0, p1); }
	static void SetDecisionMakerAttributeCaution(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_DECISION_MAKER_ATTRIBUTE_CAUTION", p0, p1); }
	static void SetDecisionMakerAttributeFireRate(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_DECISION_MAKER_ATTRIBUTE_FIRE_RATE", p0, p1); }
	static void SetDecisionMakerAttributeMovementStyle(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_DECISION_MAKER_ATTRIBUTE_MOVEMENT_STYLE", p0, p1); }
	static void SetDecisionMakerAttributeNavigationStyle(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_DECISION_MAKER_ATTRIBUTE_NAVIGATION_STYLE", p0, p1); }
	static void SetDecisionMakerAttributeRetreatingBehaviour(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_DECISION_MAKER_ATTRIBUTE_RETREATING_BEHAVIOUR", p0, p1); }
	static void SetDecisionMakerAttributeSightRange(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_DECISION_MAKER_ATTRIBUTE_SIGHT_RANGE", p0, p1); }
	static void SetDecisionMakerAttributeStandingStyle(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_DECISION_MAKER_ATTRIBUTE_STANDING_STYLE", p0, p1); }
	static void SetDecisionMakerAttributeTargetInjuredReaction(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_DECISION_MAKER_ATTRIBUTE_TARGET_INJURED_REACTION", p0, p1); }
	static void SetDecisionMakerAttributeTargetLossResponse(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_DECISION_MAKER_ATTRIBUTE_TARGET_LOSS_RESPONSE", p0, p1); }
	static void SetDecisionMakerAttributeTeamwork(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_DECISION_MAKER_ATTRIBUTE_TEAMWORK", p0, p1); }
	static void SetDecisionMakerAttributeWeaponAccuracy(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_DECISION_MAKER_ATTRIBUTE_WEAPON_ACCURACY", p0, p1); }
	...
	static void SetGroupCharDecisionMaker(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_GROUP_CHAR_DECISION_MAKER", p0, p1); }
	...
	static void SetPlayerSettingsModelVariationsChoice(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_PLAYERSETTINGS_MODEL_VARIATIONS_CHOICE", p0); }
	static void SetPtfxCamInsideVehicle(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("SET_PTFX_CAM_INSIDE_VEHICLE", p0); }
	static void SetRelationship(ScriptAny p0, ScriptAny p1, ScriptAny p2) { NativeInvoke::Invoke<ScriptVoid>("SET_RELATIONSHIP", p0, p1, p2); }
	...
	static void SetRoute(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_ROUTE", p0, p1); }
	...
	static void SetSenseRange(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SET_SENSE_RANGE", p0, p1); }
	...
	static void SetVariableOnSound(ScriptAny p0, ScriptAny p1, ScriptAny p2) { NativeInvoke::Invoke<ScriptVoid>("SET_VARIABLE_ON_SOUND", p0, p1, p2); }
	...
	static void StoreScore(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("STORE_SCORE", p0, p1); }
	...
	static void StoreWantedLevel(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("STORE_WANTED_LEVEL", p0, p1); }
	...
	static void SwitchPedToAnimated(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("SWITCH_PED_TO_ANIMATED", p0, p1); }
	...
	static void TaskAchieveHeading(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("TASK_ACHIEVE_HEADING", p0, p1); }
	static void TaskAimGunAtChar(ScriptAny p0, ScriptAny p1, ScriptAny p2) { NativeInvoke::Invoke<ScriptVoid>("TASK_AIM_GUN_AT_CHAR", p0, p1, p2); }
	static void TaskAimGunAtCoord(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4) { NativeInvoke::Invoke<ScriptVoid>("TASK_AIM_GUN_AT_COORD", p0, p1, p2, p3, p4); }
	...
	static void TaskCarDriveWander(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3) { NativeInvoke::Invoke<ScriptVoid>("TASK_CAR_DRIVE_WANDER", p0, p1, p2, p3); }
	static void TaskCarMission(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5, ScriptAny p6, ScriptAny p7) { NativeInvoke::Invoke<ScriptVoid>("TASK_CAR_MISSION", p0, p1, p2, p3, p4, p5, p6, p7); }
	static void TaskCarMissionCoorsTarget(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5, ScriptAny p6, ScriptAny p7, ScriptAny p8, ScriptAny p9) { NativeInvoke::Invoke<ScriptVoid>("TASK_CAR_MISSION_COORS_TARGET", p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); }
	static void TaskCarMissionCoorsTargetNotAgainstTraffic(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5, ScriptAny p6, ScriptAny p7, ScriptAny p8, ScriptAny p9) { NativeInvoke::Invoke<ScriptVoid>("TASK_CAR_MISSION_COORS_TARGET_NOT_AGAINST_TRAFFIC", p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); }
	static void TaskCarMissionNotAgainstTraffic(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5, ScriptAny p6, ScriptAny p7) { NativeInvoke::Invoke<ScriptVoid>("TASK_CAR_MISSION_NOT_AGAINST_TRAFFIC", p0, p1, p2, p3, p4, p5, p6, p7); }
	static void TaskCarMissionPedTarget(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5, ScriptAny p6, ScriptAny p7) { NativeInvoke::Invoke<ScriptVoid>("TASK_CAR_MISSION_PED_TARGET", p0, p1, p2, p3, p4, p5, p6, p7); }
	static void TaskCarTempAction(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3) { NativeInvoke::Invoke<ScriptVoid>("TASK_CAR_TEMP_ACTION", p0, p1, p2, p3); }
	...
	static void TaskCombat(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("TASK_COMBAT", p0, p1); }
	static void TaskCombatHatedTargetsAroundChar(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("TASK_COMBAT_HATED_TARGETS_AROUND_CHAR", p0, p1); }
	static void TaskCombatHatedTargetsAroundCharTimed(ScriptAny p0, ScriptAny p1, ScriptAny p2) { NativeInvoke::Invoke<ScriptVoid>("TASK_COMBAT_HATED_TARGETS_AROUND_CHAR_TIMED", p0, p1, p2); }
	...
	static void TaskCombatTimed(ScriptAny p0, ScriptAny p1, ScriptAny p2) { NativeInvoke::Invoke<ScriptVoid>("TASK_COMBAT_TIMED", p0, p1, p2); }
	...
	static void TaskDie(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("TASK_DIE", p0); }
	...
	static void TaskEnterCarAsDriver(ScriptAny p0, ScriptAny p1, ScriptAny p2) { NativeInvoke::Invoke<ScriptVoid>("TASK_ENTER_CAR_AS_DRIVER", p0, p1, p2); }
	static void TaskEnterCarAsPassenger(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3) { NativeInvoke::Invoke<ScriptVoid>("TASK_ENTER_CAR_AS_PASSENGER", p0, p1, p2, p3); }
	...
	static void TaskFollowNavMeshToCoord(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5, ScriptAny p6) { NativeInvoke::Invoke<ScriptVoid>("TASK_FOLLOW_NAV_MESH_TO_COORD", p0, p1, p2, p3, p4, p5, p6); }
	static void TaskFollowNavMeshToCoordNoStop(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5, ScriptAny p6) { NativeInvoke::Invoke<ScriptVoid>("TASK_FOLLOW_NAV_MESH_TO_COORD_NO_STOP", p0, p1, p2, p3, p4, p5, p6); }
	...
	static void TaskGoStraightToCoord(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5) { NativeInvoke::Invoke<ScriptVoid>("TASK_GO_STRAIGHT_TO_COORD", p0, p1, p2, p3, p4, p5); }
	...
	static void TaskGotoCharOffset(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4) { NativeInvoke::Invoke<ScriptVoid>("TASK_GOTO_CHAR_OFFSET", p0, p1, p2, p3, p4); }
	...
	static void TaskGuardCurrentPosition(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3) { NativeInvoke::Invoke<ScriptVoid>("TASK_GUARD_CURRENT_POSITION", p0, p1, p2, p3); }
	...
	static void TaskHandsUp(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("TASK_HANDS_UP", p0, p1); }
	static void TaskHeliMission(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5, ScriptAny p6, ScriptAny p7, ScriptAny p8, ScriptAny p9, ScriptAny p10, ScriptAny p11, ScriptAny p12) { NativeInvoke::Invoke<ScriptVoid>("TASK_HELI_MISSION", p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12); }
	static void TaskJump(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("TASK_JUMP", p0, p1); }
	static void TaskLeaveAnyCar(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("TASK_LEAVE_ANY_CAR", p0); }
	static void TaskLeaveCar(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("TASK_LEAVE_CAR", p0, p1); }
	...
	static void TaskLeaveCarDontCloseDoor(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("TASK_LEAVE_CAR_DONT_CLOSE_DOOR", p0, p1); }
	static void TaskLeaveCarImmediately(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("TASK_LEAVE_CAR_IMMEDIATELY", p0, p1); }
	...
	static void TaskLookAtChar(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3) { NativeInvoke::Invoke<ScriptVoid>("TASK_LOOK_AT_CHAR", p0, p1, p2, p3); }
	static void TaskLookAtCoord(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5) { NativeInvoke::Invoke<ScriptVoid>("TASK_LOOK_AT_COORD", p0, p1, p2, p3, p4, p5); }
	static void TaskLookAtObject(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3) { NativeInvoke::Invoke<ScriptVoid>("TASK_LOOK_AT_OBJECT", p0, p1, p2, p3); }
	static void TaskLookAtVehicle(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3) { NativeInvoke::Invoke<ScriptVoid>("TASK_LOOK_AT_VEHICLE", p0, p1, p2, p3); }
	...
	static void TaskPause(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("TASK_PAUSE", p0, p1); }
	static void TaskPerformSequence(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("TASK_PERFORM_SEQUENCE", p0, p1); }
	...
	static void TaskPlayAnimWithFlags(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5) { NativeInvoke::Invoke<ScriptVoid>("TASK_PLAY_ANIM_WITH_FLAGS", p0, p1, p2, p3, p4, p5); }
	...
	static void TaskSetCharDecisionMaker(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("TASK_SET_CHAR_DECISION_MAKER", p0, p1); }
	static void TaskSetCombatDecisionMaker(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("TASK_SET_COMBAT_DECISION_MAKER", p0, p1); }
	...
	static void TaskSmartFleeChar(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3) { NativeInvoke::Invoke<ScriptVoid>("TASK_SMART_FLEE_CHAR", p0, p1, p2, p3); }
	static void TaskSmartFleeCharPreferringPavements(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3) { NativeInvoke::Invoke<ScriptVoid>("TASK_SMART_FLEE_CHAR_PREFERRING_PAVEMENTS", p0, p1, p2, p3); }
	static void TaskSmartFleePoint(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3, ScriptAny p4, ScriptAny p5) { NativeInvoke::Invoke<ScriptVoid>("TASK_SMART_FLEE_POINT", p0, p1, p2, p3, p4, p5); }
	...
	static void TaskStandStill(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("TASK_STAND_STILL", p0, p1); }
	...
	static void TaskSwapWeapon(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("TASK_SWAP_WEAPON", p0, p1); }
	static void TaskToggleDuck(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("TASK_TOGGLE_DUCK", p0, p1); }
	static void TaskTurnCharToFaceChar(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("TASK_TURN_CHAR_TO_FACE_CHAR", p0, p1); }
	static void TaskTurnCharToFaceCoord(ScriptAny p0, ScriptAny p1, ScriptAny p2, ScriptAny p3) { NativeInvoke::Invoke<ScriptVoid>("TASK_TURN_CHAR_TO_FACE_COORD", p0, p1, p2, p3); }
	static void TaskUseMobilePhone(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("TASK_USE_MOBILE_PHONE", p0, p1); }
	static void TaskUseMobilePhoneTimed(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("TASK_USE_MOBILE_PHONE_TIMED", p0, p1); }
	...
	static void TaskWanderStandard(ScriptAny p0) { NativeInvoke::Invoke<ScriptVoid>("TASK_WANDER_STANDARD", p0); }
	static void TaskWarpCharIntoCarAsDriver(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("TASK_WARP_CHAR_INTO_CAR_AS_DRIVER", p0, p1); }
	static void TaskWarpCharIntoCarAsPassenger(ScriptAny p0, ScriptAny p1, ScriptAny p2) { NativeInvoke::Invoke<ScriptVoid>("TASK_WARP_CHAR_INTO_CAR_AS_PASSENGER", p0, p1, p2); }
	...
	static void UnlockRagdoll(ScriptAny p0, ScriptAny p1) { NativeInvoke::Invoke<ScriptVoid>("UNLOCK_RAGDOLL", p0, p1); }
